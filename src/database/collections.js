...
export const createTable = async (db) => {
  ...
  const query = `CREATE TABLE IF NOT EXISTS anime (
    ...
    title TEXT NOT NULL,
    image TEXT NOT NULL,
    watching BOOLEAN DEFAULT(${Number(false)}),
    completed BOOLEAN DEFAULT(${Number(false)}),
    onHold BOOLEAN DEFAULT(${Number(false)}),
    dropped BOOLEAN DEFAULT(${Number(false)}),
    planToWatch BOOLEAN DEFAULT(${Number(false)}),
